...
int main()
{
    ...
    char alumnos[NUMERO_ALUMNOS][MAXIMA_LONGITUD_CADENA] = {"Carlos","Luis","Maria","Pedro","Juan","Manuel","Mitchell","Scarleth","David","Antonio"};
    llenarMatriz(matriz);
...
void llenarMatriz(float matriz[NUMERO_ALUMNOS][NUMERO_MATERIAS + 1])
{
    ...
    for (y = 0; y < NUMERO_ALUMNOS; y++)
    {
        ...
        totalpromedio= (float)promedio+totalpromedio;
...
void imprimirMatriz(float matriz[NUMERO_ALUMNOS][NUMERO_MATERIAS + 1], char alumnos[NUMERO_ALUMNOS][MAXIMA_LONGITUD_CADENA])
{
    ...
    float promedioDeClase= totalpromedio/NUMERO_ALUMNOS;
    ...
    cout << "promedio total de la clase es de: " << setw(9) << promedioDeClase << endl;
